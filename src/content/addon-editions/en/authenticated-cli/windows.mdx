...
- **OpenCode catalog** loads `opencode/*` text models through `opencode.exe models opencode --verbose --pure`. Only models whose complete pricing object includes input and output prices and whose every numeric value—including cache and tier pricing—is zero are exposed.

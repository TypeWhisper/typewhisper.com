...
platform: mac
version: 1.1.0
description: Save transcriptions as customizable Markdown notes in your Obsidian vault, with templates, auto-export, and live sync.
...
requirements:
  ...
  - macOS 14.0 or newer
highlights:
  - Customizable Markdown note templates
  - Auto-export for every transcription
  - Live sync for later History corrections
  - Flexible daily notes and YAML frontmatter
...
screenshots:
  - src: /screenshots/plugins/obsidian.png
    alt: Obsidian settings in the macOS edition
    caption: The macOS edition detects existing vaults and reveals all template, daily-note, auto-export, and live-sync options after a vault is selected.
---

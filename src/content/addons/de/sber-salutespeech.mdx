...
Die veröffentlichte macOS-Erweiterung ist Version `0.1.1` und benötigt TypeWhisper `1.4.0` oder neuer.
...
6. Öffne in TypeWhisper Einstellungen > Integrationen > Sber SaluteSpeech und füge den Authorization Key ein.

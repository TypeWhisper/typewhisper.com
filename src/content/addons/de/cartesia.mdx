...
minAppVersion: "1.5.0"
minOsVersion: "14.0"
releaseUrl: "https://github.com/TypeWhisper/typewhisper-mac/releases/tag/plugin-cartesia-v1.0.4"
---
...
| **TypeWhisper-Host** | `1.5.0` oder neuer. | Das ist `minHostVersion` im Plugin-Manifest. |
...
5. Öffne in TypeWhisper Einstellungen > Integrationen > Cartesia und füge den API-Key ein.
...
- Die öffentliche `1.0.4`-Release benötigt TypeWhisper-Hostversion `1.5.0` oder neuer, SDK-Kompatibilität `v1` und macOS `14.0` oder neuer.

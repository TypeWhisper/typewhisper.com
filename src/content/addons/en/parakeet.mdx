...
- Live streaming preview and word-level timestamps
...
| Parakeet TDT v2 0.6B (English) | `parakeet-tdt-0.6b-v2` | ~600 MB |
...
3. Choose v3 for multilingual dictation or v2 for English, then download and load it in the plugin settings

...
| **TypeWhisper host** | `1.5.0` or newer. | This is the `minHostVersion` in the plugin manifest. |
...
5. In TypeWhisper, open Settings > Integrations > Cartesia and paste the API key.
...
- The public `1.0.4` release requires TypeWhisper host version `1.5.0` or newer, SDK compatibility `v1`, and macOS `14.0` or newer.

...
WhisperKit runs OpenAI's Whisper models locally on your Mac using Apple's CoreML framework. All processing happens entirely on-device with no cloud connection required. WhisperKit supports 99+ languages, English translation, and marks recommended models based on your available RAM.

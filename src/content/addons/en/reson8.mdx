...
| Language | Sends one language to Reson8. When multiple TypeWhisper languages are selected, the first supported language is used; with no language selected, Reson8 auto-detects. |

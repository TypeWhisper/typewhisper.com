...
version: 1.2.0
icon: AudioWaveform
description: Soniox cloud speech with regional STT/TTS endpoints, file transcription, realtime WebSocket transcription, text-to-speech, and automatic model refresh.
categories:
  - transcription
  - tts
platforms:
